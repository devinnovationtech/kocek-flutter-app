...
class KocekPinField extends StatefulWidget {
  ...
  /// The vertical padding from the [KocekPinField] to the error text
  /// Default is 16.
  ...
  @override
  _KocekPinFieldState createState() => _KocekPinFieldState();
}

class _KocekPinFieldState extends State<KocekPinField>
